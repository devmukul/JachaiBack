...
class SelectProgramFragment : BaseFragment<ProgramListFragmentBinding>(R.layout.program_list_fragment),
    ProgramListAdapter.CellClickListener {

    private lateinit var programList: MutableList<Program>
    companion object {
        fun newInstance() = SelectProgramFragment()
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.successResponseLiveData.observe(viewLifecycleOwner) {
            ...
            binding.rvRequired.adapter = ProgramListAdapter(requireContext(), it!!.programs, this)
        }

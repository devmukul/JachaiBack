...
class DiciplinListAdapter (private val context: Context,
                           private val list: MutableList<Discipline>,
                           private val cellClickListener: CellClickListener
) : RecyclerView.Adapter<DiciplinListAdapter.ViewHolder>() {
    ...
    interface CellClickListener {
        fun onCellClickListener(data: Discipline)
    }
}
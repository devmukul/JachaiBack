...
class DoggoImagePagingSource(val doggoApiService: GroceryService, val key: String) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Product> {
        ...
        return try {
            val response = doggoApiService.searchProducts(key = key, page = page, limit= params.loadSize).execute()
